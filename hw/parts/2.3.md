...
| Numbers. |                                                                             Here. |
| :-------------------- | --------------------------------------------------------------------------------: |
| First:         | <input type="number" name="num1" step="1" min="-1000000000" max="1000000000" required>|
| Second:        | <input type="number" name="num2" step="1" min="-1000000000" max="1000000000" required>|
| Third:         | <input type="number" name="num3" step="1" min="-1000000000" max="1000000000" required>|
| Fourth:        | <input type="number" name="num4" step="1" min="-1000000000" max="1000000000" required>|
| Fifth:         | <input type="number" name="num5" step="1" min="-1000000000" max="1000000000" required>|
